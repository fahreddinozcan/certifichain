...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_93a6140bc459cb04, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_93a6140bc459cb04, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "certifichain.certifichain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "certifichain.certifichain.MsgUpdateParamsResponse")
}

func init() {
	proto.RegisterFile("certifichain/certifichain/tx.proto", fileDescriptor_93a6140bc459cb04)
}

var fileDescriptor_93a6140bc459cb04 = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x4a, 0x4e, 0x2d, 0x2a,
	0xc9, 0x4c, 0xcb, 0x4c, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0xe1, 0x94, 0x54, 0xe8, 0x15, 0x14,
	...
	0x36, 0x70, 0x74, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xad, 0x29, 0x6e, 0x01, 0x74, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/certifichain.certifichain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/certifichain.certifichain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "certifichain.certifichain.Msg",
	...
	Metadata: "certifichain/certifichain/tx.proto",
}
